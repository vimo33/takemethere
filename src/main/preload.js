...
contextBridge.exposeInMainWorld('takeMeThere', {
  ...
  loadSessionHistoryEntry: (historyIndex) => ipcRenderer.invoke('session:load-history-entry', historyIndex),
  ...
  updateMappingRoom: (patch) => ipcRenderer.invoke('session:update-mapping-room', patch),
  addMappingRoomItem: (shape) => ipcRenderer.invoke('session:add-mapping-room-item', shape),
  updateMappingRoomItem: (id, patch) => ipcRenderer.invoke('session:update-mapping-room-item', id, patch),
  removeMappingRoomItem: (id) => ipcRenderer.invoke('session:remove-mapping-room-item', id),
  addMappingRoomReferencePhoto: (photo) => ipcRenderer.invoke('session:add-mapping-room-reference-photo', photo),
  updateMappingRoomReferencePhoto: (id, patch) => ipcRenderer.invoke('session:update-mapping-room-reference-photo', id, patch),
  removeMappingRoomReferencePhoto: (id) => ipcRenderer.invoke('session:remove-mapping-room-reference-photo', id),
